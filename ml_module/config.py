...
# Версия патча Dota 2
DOTA_VERSION = "740c"   # Используется в названиях файлов и моделей

# Начальный номер последовательности матчей для сбора данных
STARTING_MATCH_SEQUENCE_NUMBER = 7276314581   # Обновляется при переходе на новый патч для сбора актуальных матчей

# Unix timestamp точки отсечки для анализа данных
BURST_TIME_TIMESTAMP = 1766595600   # Fri Jan 23 2026 00:00:00 GMT+0000
