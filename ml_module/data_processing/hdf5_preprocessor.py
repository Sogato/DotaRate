...
class HDF5Preprocessor:
    ...
    def _get_match_ids(self) -> Tuple[List[int], List[int]]:
        ...
        исключенных героев. Затем воспроизводимо, разделяет полученные ID
        на две выборки для создания независимых датасетов.
        ...
        Note:
            ...
            Разбиение фиксируется сидом RANDOM_SEED: при неизменном наборе матчей
            один и тот же сид даёт идентичные выборки.
        """
