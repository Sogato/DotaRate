...
> ⚠️ **Проект в стадии рефакторинга**: Это публичная версия системы, которая находится в процессе переработки архитектуры. Оригинальная система успешно работала больше года, но была написана как прототип и использована для защиты диссертации. Текущая версия переписывается с нуля с применением принципов чистой архитектуры, ООП и современных практик разработки.
...
### Информация о матче
![Пример прогноза](docs/screenshots/bot_prediction.png)
...
![Статистика по патчу](docs/screenshots/patch_stats.png)
...
![Количество матчей по патчам](docs/screenshots/matches_by_patch.png)
...
![Прибыль по патчам](docs/screenshots/profit_by_patch.png)
...
![Итоговая рентабельность](docs/screenshots/roi_table.png)
