...
смене патча параметры, игровые константы Dota 2, пороги уверенности для
анализа прогнозов и список исключаемых героев.
...
# Общие для офлайн-тестирования моделей (ml_module) и статистики бота
# (telegram_bot): корзины обязаны совпадать, чтобы метрики тестов были
# напрямую сравнимы с фактическими результатами прогнозов в канале.
